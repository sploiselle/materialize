...
impl NullaryFunc {
    pub fn output_type(&self) -> ColumnType {
        match self {
            NullaryFunc::MzLogicalTimestamp => ScalarType::Numeric { scale: None }.nullable(false),
        }
    }
}
...
impl UnaryFunc {
    ...
    pub fn output_type(&self, input_type: ColumnType) -> ColumnType {
        ...
        match self {
            ...
            CastFloat64ToFloat32 | CastInt32ToFloat32 | CastInt64ToFloat32
            | CastNumericToFloat32 => ScalarType::Float32.nullable(in_nullable),

            CastInt32ToFloat64 | CastInt64ToFloat64 | CastFloat32ToFloat64
            | CastNumericToFloat64 => ScalarType::Float64.nullable(in_nullable),

            CastInt64ToInt32 | CastNumericToInt32 => ScalarType::Int32.nullable(in_nullable),

            CastFloat32ToInt32 | CastFloat64ToInt32 => ScalarType::Int32.nullable(true),

            CastInt32ToInt64 | CastFloat32ToInt64 | CastFloat64ToInt64 | CastNumericToInt64 => {
            ...
            | CastJsonbToNumeric(scale) => {
                ScalarType::Numeric { scale: *scale }.nullable(in_nullable)
            }
