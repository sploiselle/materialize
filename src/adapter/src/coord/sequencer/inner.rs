...
use mz_sql::ast::{CreateSubsourceStatement, Value};
use mz_sql::catalog::{
...
impl Coordinator {
    ...
    /// the primary source, and any data-bearing subsources (e.g. PG tables).
    pub(crate) async fn plan_purified_create_source(
        ...
        // Progress subsource must not have a dependency on the source.
