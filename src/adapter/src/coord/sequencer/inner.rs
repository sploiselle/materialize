...
use mz_sql::plan::{
    AlterConnectionAction, AlterConnectionPlan, AlterOptionParameter, Explainee, Index,
    IndexOption, MaterializedView, MutationKind, Params, Plan, PlannedAlterRoleOption,
    PlannedRoleVariable, QueryWhen, SideEffectingFunc, SourceSinkClusterConfig, SubscribeFrom,
...
impl Coordinator {
    ...
    pub(crate) async fn sequence_alter_connection_stage_finish(
        ...
        let ops = vec![catalog::Op::UpdateItem {
            ...
            to_item: CatalogItem::Connection(connection),
        }];
