    ...
    async fn message_purified_statement_ready(
        ...
        let plan = match purified_statement {
            ...
            PurifiedStatement::PurifiedAlterSourceAddSubsources {
                ...
                options,
                create_subsource_stmts,
            } if !create_subsource_stmts.is_empty() => {
            ...
            o => 'pur: {
                // We can produce internal errors instead of panicking.
                const PURIFICATION_CX: &str = "purifying statements";
                ...
                let stmt = match o {
                    ...
                    PurifiedStatement::PurifiedCreateSource { .. }
                    | PurifiedStatement::PurifiedAlterSourceAddSubsources { .. } => {
                        break 'pur Err(AdapterError::internal(
                            PURIFICATION_CX,
                            "unexptected purified after check",
                        ));
                    }
                };
