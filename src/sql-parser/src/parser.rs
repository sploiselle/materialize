...
impl<'a> Parser<'a> {
    ...
    fn parse_data_type(&mut self) -> Result<DataType, ParserError> {
        ...
        let data_type_name = match self.next_token() {
    ...
    fn parse_qualified_identifier(&mut self, id: Ident) -> Result<Expr, ParserError> {
