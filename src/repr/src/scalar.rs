    ...
    pub fn base_eq(&self, other: &ScalarType) -> bool {
        ...
        match (self, other) {
            ...
            (
                ...
                // These checks only apply to composite types; record types
                // (where these values are none) fall through to the BaseType
                // checks
                if oid_a.is_some() || name_a.is_some() || oid_b.is_some() || name_b.is_some() => {
                oid_a == oid_b
                    && name_a == name_b
                    ...
                    && fields_a
                        ...
                        .all(|(a, b)| {
                            a.0 == b.0
                                && a.1.scalar_type.base_eq(&b.1.scalar_type)
                        })
            }
