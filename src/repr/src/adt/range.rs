...
/// Provides a wrapper to implement the complexities of range semantics over
/// `RangeInner`.
...
/// Holds the upper and lower `DatumRangeBound`s.
...
/// Structures arguments for functions that take ranges.
#[derive(Debug, Clone, Copy, Eq, PartialEq, Hash, PartialOrd)]
